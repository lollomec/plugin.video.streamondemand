...
host = "https://misterstreaming.click"

headers = [['Referer', host]]


def mainlist(item):
    logger.info("streamondemand.misterstreaming mainlist")
...
def peliculas_tv(item):
    ...
    # Descarga la pagina
    data = httptools.downloadpage(item.url, headers=headers).data
    bloque = scrapertools.get_match(data, '<div id="text-2" class="widget widget_text">(.*?)<div id="footerwrap">')
...
def episodios(item):
    ...
    logger.info("[misterstreaming.py] episodios")
